...
### Q5：我们在您的源码基础上二次开发的出来的产品可以出售么？

和自己的软件平台或硬件设备一起作为解决方案的一部分是可以的。

### Q6：购买了源码，我想不用登录用户就能有全部功能，该怎么修改源码再打包呢？
...
### Q8：topology 1.0 企业版，为什么没有组件版？

topology 1.0 企业版引入了vuex ，vuex相关代码无法打包为lib组件


### Q9：是否可以实现：自己画的图（需要与应用系统对接进行实时数据展示的），导出为html，将html部入给客户开发的系统里，导出的html能脱离安装包正常使用吗？
