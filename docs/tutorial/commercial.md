...
![le5le topology 编辑器 企业版与开源版的差别](/img/kaiyuan.png)
...
| 内容                                     | 价格      | 说明                                                                                                  |
| ---------------------------------------- | --------- | ----------------------------------------------------------------------------------------------------- |
| 定制开发 <br /> | 中级工程师<br>3000/人天 | 如果需要在甲方指定地点开发或培训的，期间涉及的交通费、 <br />膳食费、住宿费及其他一切费用均甲方负责。 |
| 定制开发 <br /> | 高级工程师<br>4000/人天 | 如果需要在甲方指定地点开发或培训的，期间涉及的交通费、 <br />膳食费、住宿费及其他一切费用均甲方负责。 |
...
2、双方签订合同；  
3、甲方付款到乙方指定账户；  
4、vue/angular源码版：收到合同款项后乙方1个工作日内交付源码和安排开票，甲方只需提供一个指定 Github 账号，加入到乙方项目团队中，一年内甲方可以随时下载最新企业版源码，同时乙方提供一年专业技术支持服务。   
目前出售Topology-vue和Topology-angular源码版，按需购买。   
5、安装包版：收到合同款项后，乙方将 license、前后端 version 和使用说明资料发送到甲方指定邮箱，并安排开票，同时提供一年支技术持服务。  
6、企业图形库：收到合同款项后，乙方将图形库资料发送到甲方指定邮箱，并安排开票。  
7、定制开发：甲方将完整需求发送给乙方评估，乙方报价，双方确认并签订合同，付款开发，交付验收。   
8、其他产品：乐吾乐物联平台、乐吾乐Topology-3D咨询商务（17671654517，胡）。
...
**Q12：是否可以实现：自己画的图（需要与应用系统对接进行实时数据展示的），导出为html，将html部入给客户开发的系统里，导出的html能脱离安装包正常使用吗？**
