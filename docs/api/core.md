...
| options            | [Options](/topology-documents/tutorial/topology#options-选项) | 可视化引擎选项                             |
...
- options ：[Options](/topology-documents/tutorial/topology#options-选项)  
  可视化引擎选项，可缺省
...
- pen: [Pen](/topology-documents/api/pen)  
  画笔
...
- data: [TopologyData](/topology-documents/tutorial/topology#文件数据)  
...
消息通信重连（默认自动连接）。需要提前已经设置过连接配置。更多用法参考：[实时数据监听](/topology-documents/tutorial/data)
...
- lineName ：string  
  线类型名称：内置 curve、polyline、line、mind 4 种。可[自定义](/topology-documents/tutorial/line-ai)扩展。
...
扩展自定义连线类型。可参考：[自定义连线算法](/topology-documents/tutorial/line-ai)
...
**示例：**
[自定义连线算法](/topology-documents/tutorial/line-ai)
...
参考：[自定义图形库](/topology-documents/tutorial/make-component)
...
- store: [TopologyStore](/topology-documents/tutorial/topology#topologystore)  
  引擎数据存储对象

- rect: [Rect](/topology-documents/api/rect)  
  拖拽区域
...
**返回：**  
[Rect](/topology-documents/api/rect)
...
修改 [Pen](/topology-documents/api/pen) 属性值
...
- parent: [Pen](/topology-documents/api/pen)  
  父画笔
...
- pens: [Pen](/topology-documents/api/pen)[]  
  画笔数组。默认整个画布
