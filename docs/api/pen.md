...
继承 [Rect](/topology-documents/api/rect)。
...
图标 Unicode 编码。可参考： [字体图形库教程](/topology-documents/tutorial/icons)
...
参考[动画教程](/topology-documents/tutorial/animate)
...
参考[教程](/topology-documents/tutorial/pen#交互事件)
...
参考[视频教程](/topology-documents/tutorial/video)
...
根据世界坐标计算画布中相对[坐标](/topology-documents/api/pen#x-y-width-height) 。一般手动用于修改了画笔世界坐标位置后，更新相对坐标，以便保存。
