...
连线是用于绘画的线条，也可以是连接任意2个画笔对象的虚拟关系，用户可以链接任意2个节点绘制连线，也可以选择钢笔工具绘制连线

![le5le topology 连线](/img/lianxian2.gif)

### 1.3 菜单栏

顶部菜单导航，可设置Logo、公司名称、文件编辑、钢笔、铅笔、放大镜、地图、连线起点、连线终点、连线线宽、视图比例、自动锚点、锁定/解锁、预览、帮助中心、语言、登录
...
乐吾乐图形库一共分为三大类：基础图形库、电力能源图形库、物联网图形库，总共约3700个图元，能满足大部分行业的基本需求。
